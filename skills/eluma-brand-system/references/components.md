...
.stat-value { font-size: 28px; font-weight: 200; color: #f8fafc; }
.stat-label { font-size: 12px; color: #718096; letter-spacing: 1px; }
...
.modal-desc { font-size: 13px; color: #718096; line-height: 1.6; }
...
.radio-card:hover { border-color: rgba(79,209,197,0.3); }
.radio-card.selected {
  border-color: #4fd1c5;
...
.toast.info { border-left-color: #4fd1c5; }
...
.toast-icon.info { background: rgba(79,209,197,0.15); color: #4fd1c5; }
```
...
.page-btn:hover { border-color: #4fd1c5; color: #4fd1c5; }
.page-btn.active {
  background: #4fd1c5; color: #0f172a;
  border-color: #4fd1c5; font-weight: 600;
}
```
...
.badge-info { background: rgba(79,209,197,0.1); color: #4fd1c5; }
.badge-admin { background: rgba(79,209,197,0.15); color: #4fd1c5; }
.badge-editor { background: rgba(59,130,246,0.15); color: #3b82f6; }
```
...
.empty-desc { font-size: 13px; color: #718096; line-height: 1.6; max-width: 240px; margin-bottom: 20px; }
```

Use inline SVG illustrations with #4fd1c5 strokes (opacity 0.3) for empty state icons.
...
.spinner-orbital .ring:nth-child(2) {
  inset: 6px; border-top-color: #38b2ac;
...
.spinner-pulse span {
  ...
  background: #4fd1c5; animation: pulse 1.4s ease-in-out infinite;
}
...
.spinner-wave span {
  ...
  background: #4fd1c5; animation: wave 1.2s ease-in-out infinite;
}
...
.spinner-gradient {
  ...
  background: conic-gradient(from 0deg, transparent, #4fd1c5);
...
```css
.shimmer {
  background: linear-gradient(90deg, rgba(79,209,197,0.03) 25%, rgba(79,209,197,0.08) 50%, rgba(79,209,197,0.03) 75%);
...
.tab:hover { color: #f8fafc; background: rgba(255,255,255,0.04); }
.tab.active {
...
<svg viewBox="0 0 60 60">
  <polygon points="30,2 52,16 52,44 30,58 8,44 8,16"
           fill="rgba(79,209,197,0.2)" stroke="#4fd1c5" stroke-width="1.5"/>
</svg>
```
